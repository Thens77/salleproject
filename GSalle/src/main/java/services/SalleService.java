...
public class SalleService implements IDao<Salle> {
	...
	public Salle findById(int id) {
        ...
        try {
            ...
            if (rs.next()) {
                return new Salle(rs.getInt("id"), rs.getString("code"), rs.getString("capacite"),
                		rs.getString("type"));
            }
	...
	public List<Salle> findAll() {
		 List<Salle> salles = new ArrayList<Salle>();
	        ...
	        try {
	            ...
	            ResultSet rs = ps.executeQuery();
	            while (rs.next()) {
	                salles.add(new Salle(rs.getInt("id"), rs.getString("code"), rs.getString("capacite"),
	                		rs.getString("type")));
	            }

...
<script src="script/creneau.js" type="text/javascript"></script>
<script
			...
			<div class="main-panel">
					...
					<div class="row">
						<div class="col-sm-4">
							...
							<div class="card">
								<div class="card-body">
									<h4 class="card-title">Formulaire des creneaux</h4>
									<p class="card-description">Veuillez remplir les
										informations des creneaux :</p>
									<form class="forms-sample" name="salleform">
										<div class="form-group">
											<label for="exampleInputUsername1">heure de debut</label> <input
												type="time" name="debut" id="debut" class="form-control"
												placeholder="heure de debut" required>
										</div>
										<div class="form-group">
											<label for="exampleInpu tEmail1">heure de fin</label> <input
												type="time" name="fin" id="fin"
												class="form-control" placeholder="heure de fin" required>
										</div>
										


										<button type="button" id="add" class="btn btn-info mr-2">Ajouter</button>
						...
						<div class="col-sm-6">
							<fieldset>
								...
								<table border="1" class="table  table-hover" id="table">
									...
									<tbody id="contentC" class="bg-white">

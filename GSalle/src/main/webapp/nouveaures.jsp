...
<script src="script/nouveaures.js" type="text/javascript"></script>
<script
					...
					<div class="row">
						...
						<div class="col-2 text-align-right">
						 ...
						 <input
							...
							placeholder="recherche" size="30" onkeyup="myFunction()"
							>
					</div>
						</div>
					</div>
					<div class="row">
							...
							<fieldset>
								...
								<table border="1" class="table  table-hover" id="table">
									...
									<tbody id="contentN" class="bg-white">
